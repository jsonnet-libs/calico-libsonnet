{
  ...
  spec: {
    ...
    '#withNumAllowedLocalASNumbers':: d.fn(help='"Maximum number of local AS numbers that are allowed in the AS path for received routes. This removes BGP loop prevention and should only be used if absolutely necesssary."', args=[d.arg(name='numAllowedLocalASNumbers', type=d.T.integer)]),
