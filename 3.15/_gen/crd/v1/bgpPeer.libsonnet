{
  ...
  spec: {
    ...
    '#withNode':: d.fn(help='"The node name identifying the Calico node instance that is peering with this peer. If this is not set, this represents a global peer, i.e. a peer that peers with every node in the deployment."', args=[d.arg(name='node', type=d.T.string)]),
    ...
    '#withPeerIP':: d.fn(help='"The IP address of the peer."', args=[d.arg(name='peerIP', type=d.T.string)]),
