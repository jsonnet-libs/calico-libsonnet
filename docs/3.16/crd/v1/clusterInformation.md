---
permalink: /3.16/crd/v1/clusterInformation/
---

# crd.v1.clusterInformation
...
* [`obj spec`](#obj-spec)
  * [`fn withCalicoVersion(calicoVersion)`](#fn-specwithcalicoversion)
  * [`fn withClusterGUID(clusterGUID)`](#fn-specwithclusterguid)
  * [`fn withClusterType(clusterType)`](#fn-specwithclustertype)
  * [`fn withDatastoreReady(datastoreReady)`](#fn-specwithdatastoreready)
...
new returns an instance of ClusterInformation
...
### fn spec.withCalicoVersion

```ts
withCalicoVersion(calicoVersion)
```

"CalicoVersion is the version of Calico that the cluster is running"

### fn spec.withClusterGUID

```ts
withClusterGUID(clusterGUID)
```
...
### fn spec.withDatastoreReady

```ts
withDatastoreReady(datastoreReady)
```
