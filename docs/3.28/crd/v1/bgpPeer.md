...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMaxRestartTime(maxRestartTime)`](#fn-specwithmaxrestarttime)
  * [`fn withNode(node)`](#fn-specwithnode)
  * [`fn withNodeSelector(nodeSelector)`](#fn-specwithnodeselector)
  * [`fn withNumAllowedLocalASNumbers(numAllowedLocalASNumbers)`](#fn-specwithnumallowedlocalasnumbers)
  * [`fn withPeerIP(peerIP)`](#fn-specwithpeerip)
  * [`fn withPeerSelector(peerSelector)`](#fn-specwithpeerselector)
  * [`fn withReachableBy(reachableBy)`](#fn-specwithreachableby)
  * [`fn withSourceAddress(sourceAddress)`](#fn-specwithsourceaddress)
  * [`fn withTtlSecurity(ttlSecurity)`](#fn-specwithttlsecurity)
...
### fn spec.withMaxRestartTime

```ts
withMaxRestartTime(maxRestartTime)
```
...
### fn spec.withNumAllowedLocalASNumbers

```ts
withNumAllowedLocalASNumbers(numAllowedLocalASNumbers)
```
...
### fn spec.withReachableBy

```ts
withReachableBy(reachableBy)
```
...
### fn spec.withTtlSecurity

```ts
withTtlSecurity(ttlSecurity)
```
